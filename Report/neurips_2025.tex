...
\author{%
    \begin{tabular}{c c}
        ...
        \texttt{dangnhan0610@gmail.com} & \texttt{phongletu78@gmail.com} \\[1.2em]
...
Bộ dữ liệu mô phỏng hoạt động kinh doanh của một doanh nghiệp thương mại điện tử thời trang tại Việt Nam (2012–2022) bao gồm 13 bảng dữ liệu chính. Qua quá trình kiểm định chất lượng, nhóm chúng tôi xác nhận dữ liệu có tính đầy đủ (Completeness) cao, ngoại trừ các cột mã khuyến mãi (promo\_id) có tỉ lệ trống hợp lý do đặc thù giao dịch. Dữ liệu đạt tính nhất quán (Consistency) tuyệt đối về các mối quan hệ khóa ngoại (Foreign Keys) và không có bản ghi trùng lặp.

\section{Phần 2: Trực quan hóa và phân tích dữ liệu}
\subsection{Phân tích Mô tả: Điều gì đã xảy ra?}
\subsubsection{Xu hướng doanh thu theo thời gian và tính mùa vụ}

\subsection{Phân tích Chẩn đoán: Tại sao nó xảy ra?}
\subsubsection{Phân tích doanh thu – biên lợi nhuận theo danh mục sản phẩm}

\subsubsection{Phân khúc khách hàng và rủi ro rời bỏ (RFM Analysis)}

\subsubsection{Phân tích nguyên nhân hoàn trả hàng và thất thoát vận hành}

\subsection{Phân tích Dự báo: Điều gì sẽ xảy ra?}
\subsubsection{Dự báo doanh thu và mô hình mùa vụ}

\subsection{Phân tích Đề xuất: Chúng ta nên làm gì?}
\subsubsection{Chiến lược phân bổ tồn kho và tối ưu hóa ROI khuyến mãi}
